# C PROGRAMMING ALX AFRICA `0x00. C - Hello, World`

### Note: When doing this project, After using text editor of your choice to create and access the file on insert mode.Ensure the first line is always having shebang `#!/bin/bash`, then the second line is having the correct command/answer.
